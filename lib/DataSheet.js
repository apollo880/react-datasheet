  ...
  _createClass(DataSheet, [{
    ...
    value: function handleKeyboardCellMovement(e) {
      ...
      if (keyCode === _keys.TAB_KEY) {
        ...
        this.handleNavigate(e, { i: 1, j: 0 });
      } else if (commit && keyCode === _keys.ENTER_KEY && end.i > start.i && end.j === start.j) {
    ...
    value: function handleKey(e) {
      ...
      var equationKeysPressed = [187 /* equal */, 189 /* substract */, 190 /* period */, 107 /* add */
      , 109 /* decimal point */, 110].indexOf(keyCode) > -1;
